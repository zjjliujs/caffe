...
class Detector(caffe_double.Net):
    """
    ...
    def __init__(self, model_file, pretrained_file, mean=None,
                 ...
                 context_pad=None):
        caffe_double.Net.__init__(self, model_file, caffe.TEST, weights=pretrained_file)

        # configure pre-processing
        in_ = self.inputs[0]
        self.transformer = caffe_double.io.Transformer(
    ...
    def detect_windows(self, images_windows):
        ...
        for image_fname, windows in images_windows:
            image = caffe_double.io.load_image(image_fname).astype(np.float32)
    ...
    def crop(self, im, window):
        ...
        if self.context_pad:
            ...
            context_crop = caffe_double.io.resize_image(context_crop, (crop_h, crop_w))
