...
import caffe_double
from caffe_double import layers as L
from caffe_double import params as P
from caffe_double.coord_map import coord_map_from_to, crop
