...
class SimpleLayer(caffe_double.Layer):
...
class ExceptionLayer(caffe_double.Layer):
    """A layer for checking exceptions from Python"""

    def setup(self, bottom, top):
        raise RuntimeError

class ParameterLayer(caffe_double.Layer):
    """A layer that just multiplies by ten"""
...
class PhaseLayer(caffe_double.Layer):
...
@unittest.skipIf('Python' not in caffe_double.layer_type_list(),
...
class TestPythonLayer(unittest.TestCase):
    ...
    def test_exception(self):
        ...
        self.assertRaises(RuntimeError, caffe_double.Net, net_file, caffe.TEST)
        os.remove(net_file)
